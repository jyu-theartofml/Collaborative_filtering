...
<p><b>UPDATE: I have added the code for Alternating Least Square (ALS) recommender using Spark MLlib's API. This was written to be ran on Amazon's EMR cluster. The performance of ALS was not as good as the matrix factorization by Stochastic Gradient Descend.</b></p>
